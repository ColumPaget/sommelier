...
static int pmatch_charlist(const char **P_PtrPtr, char S_Char, int Flags)
{
...
static int pmatch_repeat(const char **P_PtrPtr, const char **S_PtrPtr, const char *S_End, int *Flags)
{
